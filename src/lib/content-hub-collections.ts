...
> = {
  ...
  places: {
    fields: [
      ...
      "services_notes", "capacity_notes", "restrictions_notes",
      "access_notes", "parking_notes", "public_transport_notes",
      "latitude", "longitude", "map_label", "map_icon", "map_priority", "show_on_map",
    ],
    sort: "sort,title",
    limit: 250,
  },
  routes: {
    fields: [
      "id", "status", "sort", "title", "slug", "summary", "description", "image",
      "difficulty", "distance_km", "duration_minutes", "elevation_gain_m",
