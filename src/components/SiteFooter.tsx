  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <div className="footer-column"><strong>Esplora</strong><Link href="/percorsi">Percorsi</Link><Link href="/eventi">Eventi</Link><Link href="/luoghi">Luoghi</Link><Link href="/memoria">Memoria</Link><Link href="/#mappa">Mappa</Link></div>
