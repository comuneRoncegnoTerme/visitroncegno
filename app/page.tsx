...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <section className="story-section" id="storie"><div className="story-image" style={{ backgroundImage: "url('/images/hero/roncegno-hero.jpg')", backgroundPosition: "center 62%" }} /><div className="story-copy"><p className="eyebrow accent">Storie e memoria</p><h2>Un territorio<br />che si racconta.</h2><p>Fotografie, testimonianze e luoghi custodiscono la memoria della comunità. Un patrimonio da conoscere e tramandare.</p><a className="text-link light-link" href="#storie">Leggi le storie<ArrowIcon /></a></div></section>
