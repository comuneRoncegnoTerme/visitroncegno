...
import HomepageSkylineDivider from "@/components/HomepageSkylineDivider";
...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <section className="quick-search" id="scopri">
        <div className="section-shell">
          ...
          <div className="quick-links">
            ...
            <Link href="/organizza-la-visita"><span className="quick-number">04</span><span><strong>Mangiare e dormire</strong><small>Ospitalità, sapori e informazioni pratiche</small></span><ArrowIcon /></Link>
          </div>
        </div>
      </section>
      ...
      <HomepageSkylineDivider />

      <section className="story-section" id="storie"><div className="story-image" style={{ backgroundImage: "url('/images/memoria/banner-memoria.jpg')", backgroundPosition: "center 48%" }} /><div className="story-copy"><p className="eyebrow accent">Storie e memoria</p><h2>Un territorio<br />che si racconta.</h2><p>Fotografie, testimonianze e luoghi custodiscono la memoria della comunità. Un patrimonio da conoscere e tramandare.</p><Link className="text-link light-link" href="/memoria">Entra nell’archivio<ArrowIcon /></Link></div></section>

      <section className="planning-section" id="organizza"><div className="section-shell planning-grid"><div><p className="eyebrow dark">Organizza la visita</p><h2 className="display-heading">Tutto ciò che serve<br />per partire.</h2><Link className="text-link" href="/organizza-la-visita">Apri la guida pratica<ArrowIcon /></Link></div><div className="planning-links"><Link href="/organizza-la-visita#dormire"><span><small>Ospitalità</small><strong>Dove dormire</strong></span><ArrowIcon /></Link><Link href="/organizza-la-visita#mangiare"><span><small>Sapori</small><strong>Dove mangiare</strong></span><ArrowIcon /></Link><Link href="/organizza-la-visita#servizi"><span><small>Informazioni</small><strong>Servizi utili</strong></span><ArrowIcon /></Link><Link href="/organizza-la-visita#come-arrivare"><span><small>Mobilità</small><strong>Come arrivare</strong></span><ArrowIcon /></Link></div></div></section>
